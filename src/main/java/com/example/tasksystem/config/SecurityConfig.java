...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/tasks", "/getLastModified").hasAuthority("USER")
                .antMatchers("/tasks/form").hasAuthority("USER")
                .antMatchers("/tasks/new").hasAuthority("USER")
                .antMatchers("/tasks/new/form").hasAuthority("USER")
                .antMatchers("/admin", "/admin/form", "/admin/newTaskForm").hasAuthority("ADMIN")
